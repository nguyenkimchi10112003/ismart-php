                    ...
                    <div class="wp-inner">
                        ...
                        <div id="main-menu-wp" class="fl-right">
                            <ul id="main-menu" class="clearfix">
                                ...
                                <li>
                                    <a href="gioi-thieu-1.html" title="">Giới thiệu</a>
                                </li>
                                <li>
                    ...
                    <div class="wp-inner">
                        ...
                        <div id="action-wp" class="fl-right">
                            <div id="advisory-wp" class="fl-left">
                                ...
                                <span class="phone">0336.293.669</span>
                            </div>
                                            ...
                                            ?>
                                                <li class="clearfix">
                                                    ...
                                                    <div class="info fl-right">
                                                        ...
                                                        <p class="qty">Số lượng: <span><?php if (!empty($_SESSION['cart']['buy'])) echo $_SESSION['cart']['buy'][$item['id']]['quantity']; ?></span></p>
                                                    </div>
                                                </li>
                                            <?php
                                            }
