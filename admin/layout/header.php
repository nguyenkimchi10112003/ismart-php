                    ...
                    <ul id="main-menu" class="fl-left">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?mod=post&controller=indexCategory" title="">Danh mục bài viết</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?mod=product&controller=indexCategory" title="">Danh mục sản phẩm</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="?mod=sales&controller=indexGuest" title="">Danh sách khách hàng</a>
                                </li>
                            </ul>
                        </li>
                        <li>
