...
function send_email($send_to_mail,$send_to_fullname,$subject,$content)
{
    global $config;
    ...
    try {
        ...
        //Attachments
        // $mail->addAttachment('vegata.jpg');         //Add attachments
        //$mail->addAttachment('vegeta.jpg', 'vegetablue.jpg');    //Optional name
